---
title: "Critical Thinking about Evidence (Baysesian Belief Network) - Calculation Sheet"
...
**phone call:**	X's cell phone was used to call someone only X knows while X claims J had the phone (Evidence #5)  
...
evidence_1_col_names <- text_spec(c("Person", "P[i Guilty]", "P[lent car to J|i Guilty]",
                     "P[i|lent car to J]", "Diagnostic Benefit"), format = "latex", bold = TRUE)


evidence_2_col_names <- text_spec(c("Person", "P[i Guilty][note]", "P[AFR[note]|i Guilty]",
                    "P[i|AFR]", "Diagnostic Benefit"), format = "latex", bold = TRUE)


evidence_3_col_names <- text_spec(c("Person", "P[i Guilty][note]", "P[smoked[note]|i Guilty]",
                    "P[i|smoked]", "Diagnostic Benefit"), format = "latex", bold = TRUE)


evidence_4_col_names <- text_spec(c("Person", "P[i Guilty][note]", "P[AATF[note]|i Guilty]",
                    "P[i|AATF]", "Diagnostic Benefit"), format = "latex", bold = TRUE)


evidence_5_col_names <- text_spec(c("Person", "P[i Guilty][note]", "P[phone call[note]|i Guilty]",
...
```{r prior-dists, fig.width = 10, fig.height = 7, fig.align = "center", fig.cap = "Prior distribution and likelihood distribution from 10,000 draws from fit beta distributions"}
sims %>% 
  mutate(person = factor(person, levels = c("X", "J", "O")),
         key = factor(key, 
...
In order to assess the fit, the 5^th^, 50^th^, and the 95^th^ percentiles were taken from each of the simulated distributions and compared to the empirical values (\ref{tab:diagnosing-sims-fit}). 
...
probs %>% 
  ...
  kable(booktabs = TRUE, caption = "Difference between empirical quantiles and simulated data quantiles")
...
```{r monte-fig, fig.width = 10, fig.height = 7, fig.align = "center", fig.cap = "Posterior probability distributions for each suspect's guilt given each subsequent piece of evidence produced"}
