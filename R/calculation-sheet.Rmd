...
\[
P[?|lent car to J] = (P[lent car|?]*P[?]) / ((P[lent car|X]*P[X]) + (P[lent car|J]*P[J]) + (P[lent car|O]*P[O]))
\]

\[
P[?|AFR] = (P[AFR|?]*P[?]) / ((P[AFR|X]*P[X]) + (P[AFR|J]*P[J]) + (P[AFR|O]*P[O])) 
\]

\[
P[?|smoked] = (P[smoked|?]*P[?]) / ((P[smoked|X]*P[X]) + (P[smoked|J]*P[J]) + (P[smoked|O]*P[O]))
\]

\[
P[?|AATF] = (P[AATF|?]*P[?]) / ((P[AATF|X]*P[X]) + (P[AATF|J]*P[J]) + (P[AATF|O]*P[O]))
\]

\[
P[?|phone call] = (P[phone call|?]*P[?]) / ((P[phone call|X]*P[X]) + (P[phonecall|J]*P[J]) + (P[phone call|O]*P[O]))
\]

\[
Diagnostic Benefit = P[evidence|?] / P[evidence|not ?]
\]

\[
P[evidence|not ?] = (P[evidence|not?1]*P[evidence?1] + P[evidence|not?2]*P[evidence?2])/(1-P[? guilty])
\]
...
evidence_1_col_names <- text_spec(c("Person", "P[? Guilty]", "P[lent car to J|? Guilty]",
                     "P[?|lent car to J]", "Diagnostic Benefit"), format = "latex", bold = TRUE)


evidence_2_col_names <- text_spec(c("Person", "P[? Guilty][note]", "P[AFR[note]|? Guilty]",
                    "P[?|AFR]", "Diagnostic Benefit"), format = "latex", bold = TRUE)


evidence_3_col_names <- text_spec(c("Person", "P[? Guilty][note]", "P[smoked[note]|? Guilty]",
                    "P[?|smoked]", "Diagnostic Benefit"), format = "latex", bold = TRUE)


evidence_4_col_names <- text_spec(c("Person", "P[? Guilty][note]", "P[AATF[note]|? Guilty]",
                    "P[?|AATF]", "Diagnostic Benefit"), format = "latex", bold = TRUE)


evidence_5_col_names <- text_spec(c("Person", "P[? Guilty][note]", "P[phone call[note]|? Guilty]",
                    "P[?|phone call]", "Diagnostic Benefit"), format = "latex", bold = TRUE)
...
kable(evidence_3, format = "latex", booktabs = TRUE, align = "c", col.names = evidence_3_col_names,
  ...
  column_spec(4, width = "10em") %>%
  kable_styling(position = "center", latex_options = "HOLD_position") %>%
  add_footnote(c("P[? Guilty] for evidence 3 is the output value for P[?|AFR] from evidence 2",
                 "smoked = X and J smoked marijiuana and X was
...
kable(evidence_4, format = "latex", booktabs = TRUE, align = "c", col.names = evidence_4_col_names,
  ...
  column_spec(4, width = "10em") %>%
  kable_styling(position = "center", latex_options = "HOLD_position") %>%
  add_footnote(c("P[? Guilty] for evidence 4 is the output value for P[?|smoked] from evidence 3",
                 "AATF = J confessed that X murdered victim and J
...
kable(evidence_5, format = "latex", booktabs = TRUE, align = "c", col.names = evidence_5_col_names,
  ...
  column_spec(4, width = "10em") %>%
  kable_styling(position = "center", latex_options = "HOLD_position") %>%
  add_footnote(c("P[? Guilty] for evidence 5 is the output value for P[?|AATF] from evidence 4",
                 "phone call = X's cell phone was used to call
