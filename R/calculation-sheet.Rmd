---
title: "Baysesian Belief Network Project - Calculation Sheet"
...
**lent car to J:** X lent his car to J for the day  
**AFR:** X asked victim for ride  
**smoked:** X & J smoked marijiuna and X was nervious when police called  
**AATF:** J confessed that X murdered victim and J helped cover it up (accessory after the fact)  
**phone call:**	X's cell phone was used to call someone only X knows while X claims J had the phone  
...
Prob[X Guilty] - `r input %>% filter(key == "prior") %>% select(X)`  
Prob[J Guilty] - `r input %>% filter(key == "prior") %>% select(J)`  
Prob[O Guilty] - `r input %>% filter(key == "prior") %>% select(O)`  
...
evidence_1_col_names <- text_spec(c("Person", "Prob[i Guilty]", "Prob[lent car to J|i Guilty]",
                     "Prob[i|lent car to J]", "Diagnostic Benefit"), format = "latex", bold = TRUE)


evidence_2_col_names <- text_spec(c("Person", "Prob[i Guilty][note]", "Prob[AFR[note]|i Guilty]",
                    "Prob[i|AFR]", "Diagnostic Benefit"), format = "latex", bold = TRUE)


evidence_3_col_names <- text_spec(c("Person", "Prob[i Guilty][note]", "Prob[smoked[note]|i Guilty]",
                    "Prob[i|smoked]", "Diagnostic Benefit"), format = "latex", bold = TRUE)


evidence_4_col_names <- text_spec(c("Person", "Prob[i Guilty][note]", "Prob[AATF[note]|i Guilty]",
                    "Prob[i|AATF]", "Diagnostic Benefit"), format = "latex", bold = TRUE)


evidence_5_col_names <- text_spec(c("Person", "Prob[i Guilty][note]", "Prob[phone call[note]|i Guilty]",
                    "Prob[i|phone call]", "Diagnostic Benefit"), format = "latex", bold = TRUE)

# evidence_1_col_names <- as_tibble(c("Person", "P[? Guilty]", "P[lent car to J|? Guilty]", 
#                     "P[?|lent car to J]", "Diagnostic Benefit")) %>% 
#   mutate(alpha = c("A", "B", "C", "D", "E")) %>% 
#   spread(key = alpha, value = value)
# 
# evidence_2_col_names <- as_tibble(c("Person", "P[? Guilty][note]", "P[AFR[note]|? Guilty]", 
#                     "P[?|AFR]", "Diagnostic Benefit")) %>% 
#   mutate(alpha = c("A", "B", "C", "D", "E")) %>% 
#   spread(key = alpha, value = value)
# 
# evidence_3_col_names <- as_tibble(c("Person", "P[? Guilty][note]", "P[smoked[note]|? Guilty]", 
#                     "P[?|smoked]", "Diagnostic Benefit")) %>% 
#   mutate(alpha = c("A", "B", "C", "D", "E")) %>% 
#   spread(key = alpha, value = value)
# 
# evidence_4_col_names <- as_tibble(c("Person", "P[? Guilty][note]", "P[AATF[note]|? Guilty]", 
#                     "P[?|AATF]", "Diagnostic Benefit")) %>% 
#   mutate(alpha = c("A", "B", "C", "D", "E")) %>% 
#   spread(key = alpha, value = value)
# 
# evidence_5_col_names <- as_tibble(c("Person", "P[? Guilty][note]", "P[phone call[note]|? Guilty]", 
...
kable(evidence_2, format = "latex", booktabs = TRUE, align = "c", col.names = evidence_2_col_names,
  ...
  column_spec(4, width = "10em") %>%
  kable_styling(position = "center", latex_options = "HOLD_position") %>%
  add_footnote(c("Prob[i Guilty] for evidence 2 is the output value for Prob[i|lent car to J] from evidence 1",
...
kable(evidence_3, format = "latex", booktabs = TRUE, align = "c", col.names = evidence_3_col_names,
  ...
  column_spec(4, width = "10em") %>%
  kable_styling(position = "center", latex_options = "HOLD_position") %>%
  add_footnote(c("Prob[i Guilty] for evidence 3 is the output value for Prob[i|AFR] from evidence 2",
                 "smoked = X and J smoked marijiuana and X was
...
kable(evidence_4, format = "latex", booktabs = TRUE, align = "c", col.names = evidence_4_col_names,
  ...
  column_spec(4, width = "10em") %>%
  kable_styling(position = "center", latex_options = "HOLD_position") %>%
  add_footnote(c("Prob[i Guilty] for evidence 4 is the output value for Prob[i|smoked] from evidence 3",
                 "AATF = J confessed that X murdered victim and J
...
kable(evidence_5, format = "latex", booktabs = TRUE, align = "c", col.names = evidence_5_col_names,
  ...
  column_spec(4, width = "10em") %>%
  kable_styling(position = "center", latex_options = "HOLD_position") %>%
  add_footnote(c("Prob[i Guilty] for evidence 5 is the output value for Prob[i|AATF] from evidence 4",
                 "phone call = X's cell phone was used to call
